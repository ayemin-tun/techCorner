<header x-data="{ scrolled: false }" @scroll.window="scrolled = window.scrollY > 0" :class="{ 'shadow-lg': scrolled }" class="sticky z-40 top-0 flex-wrap md:justify-start md:flex-nowrap w-full bg-transparent text-sm py-3 md:py-0 p-5 bg-gradient-to-r from-blue-200 to-cyan-200 transition-shadow duration-300">
    <nav class="max-w-[85rem] w-full mx-auto px-4 md:px-6 lg:px-8" aria-label="Global">
        <div class="flex justify-between p-1">
            ...
            <div class="md:hidden flex gap-1 items-center" x-data="{ open: false }">
                <a href="/cart" wire:navigate class="flex items-center">
                    ...
                    <span class="top-0 py-0.5 px-1.5 rounded-full text-xs font-medium bg-white text-blue-600">3</span>
                </a>
                ...
                <div x-show="open" x-transition class="fixed inset-0 z-50 bg-white dark:bg-gray-800 p-5 flex flex-col space-y-4">
