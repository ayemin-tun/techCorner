                    ...
                    <div wire:loading.remove class="flex flex-wrap items-center ">
                        ...
                        <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key={{$product->id}}>
                            <div class="border border-gray-300 dark:border-gray-700">
                                ...
                                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700 hover:bg-blue-600 hover:text-white duration-200 transition-colors cursor-pointer">

                                    <a href="#" class="flex items-center space-x-2 dark:text-gray-400  dark:hover:text-red-300">
