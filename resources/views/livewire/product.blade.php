                ...
                <div class="w-full px-3 lg:w-3/4">
                    <div class="px-3 mb-4 flex justify-between">
                        ...
                        <div class="relative">
                            ...
                            <span class="absolute right-7 top-3 text-blue-600 animate-spin" wire:loading wire:target="search, selected_categories, selected_brands, featured, on_sale, price_range, sort">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                    ...
                    <!-- Loading Spinner -->
                    <div wire:loading.flex wire:target="search, selected_categories, selected_brands, featured, on_sale, price_range, sort" class="w-full flex flex-wrap items-center">
                        @include('livewire.components.products.skeleton-loader')
                    </div>
                    @if($products->count()>0)
                    <div wire:loading.remove wire:target="search, selected_categories, selected_brands, featured, on_sale, price_range, sort" class="flex flex-wrap items-center ">
                        ...
                        <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key={{$product->id}}>
                            <div class="border border-gray-300 dark:border-gray-700">
                                ...
                                <div class="flex justify-center p-4 border-t border-gray-300 dark:border-gray-700 hover:bg-blue-600 hover:text-white duration-200 transition-colors cursor-pointer" wire:click.prevent='addToCart({{$product->id}})'>
                    ...
                    @else
                    <div wire:loading.remove wire:target="search, selected_categories, selected_brands, featured, on_sale, price_range, sort" class="flex justify-center p-4 mt-10">
